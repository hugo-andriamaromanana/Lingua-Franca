...
def dropdown_form():
    ...
    if request.method == 'POST':
        ...
        output_text = translate(input_text, languages_data_swapped[selected_language1], languages_data_swapped[selected_language2])

        current_datetime = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        add_dic_as_row_in_csv(history_filepath, current_datetime, selected_language1, selected_language2, input_text, output_text)
